...
def filter_clones(adata, min_cells=1):
    """Filter clones based on the number of cells
    Parameters
    ----------
    adata: `AnnData`
        Annotated data matrix.
...
def filter_clone_traj(adata, min_cells=1):
    """Filter clone paths based on the number of cells

...
def _wasserstein_parallel(mat_clone,
    ...
    for i in range(num_clones):
        ...
        for j in range(i):
            ...
            params = [cells_in_i, coords_for_i, time_for_i, cells_in_j, coords_for_j, time_for_j, time_steps, num_dim, choice]
...
def calc_dist(params):
    dist = 0
    cells_in_i, coords_for_i, time_for_i, cells_in_j, coords_for_j, time_for_j, time_steps, num_dim, choice = params
    for t in time_steps:
